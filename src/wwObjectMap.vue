...
export default {
    ...
    methods: {
        ...
        pJS(_element, params) {
            ...
            let _canvas_el = _element.getElementsByClassName('particles-js-canvas-el');
            let canvas_el = _canvas_el[0];
            //var canvas_el = element.firstChild;
            ...
            pJS.fn.canvasInit = function () {
                ...
                // pJS.canvas.ctx = pJS.canvas.getContext('2d');
            };
            ...
            pJS.fn.canvasSize = function () {
                ...
                // this.$on('resize-images', pJS.fn.canvasResize);
                // this.$on('website-loaded', function () {
                //     $timeout(function () {
                //         pJS.fn.canvasResize()
                //     }, 1000)
                // });
            ...
            pJS.fn.vendors.exportImg = function () {
                _element.open(pJS.canvas.el.toDataURL('image/png'), '_blank');
            };
        ...
        particlesJS(tag_id, params, el) {
            ...
            /* launch particle.js */
            if (canvas != null) {
                this.pJSDom.push(new this.pJS(pJS_tag[0], params));
            }
